...
const nextConfig: NextConfig = {
  ...
  // @prisma/client ships a native query engine — keep it external so webpack
  // doesn't bundle/mangle it.
  serverExternalPackages: ["@resvg/resvg-wasm", "@prisma/client", "prisma"],
  images: {
    remotePatterns: [
      {
        protocol: "https",
